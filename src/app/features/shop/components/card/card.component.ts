...
export class CardComponent implements OnInit {
  productDemo: ProductModel = {
    id: "27498759",
    images: ['https://www.ubuy.tn/productimg/?image=aHR0cHM6Ly9tLm1lZGlhLWFtYXpvbi5jb20vaW1hZ2VzL0kvNjFVR0U5Y1pWbEwuX0FDX1NMMTUwMF8uanBn.jpg'],
  ...
  @Input('product') product: ProductModel = this.productDemo;
